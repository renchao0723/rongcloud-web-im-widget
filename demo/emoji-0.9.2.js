...
(function(b) {
  ...
  if (b.RongIMLib) {
      ...
      if (document.createStyleSheet) {
        initBtag = function(position) {
          ...
          e.style.backgroundImage =
            'url(http://res.websdk.rongcloud.cn/css-sprite_bg.png)';
        ...
        _style.innerHTML =
          ".RC_Expression {width:22px;height:22px;background-image:url(http://res.websdk.rongcloud.cn/css-sprite_bg.png);display:inline-block}";
    ...
    b.RongIMLib.Expression = new function() {
      initCss();
      var e = this;
      //得到所有表情对象 0-127
