...
(function (RongIMLib) {
    var RongIMEmoji = (function () {
        ...
        RongIMEmoji.calcUTF = function (d) {
            var me = this;
         ...
         */
        RongIMEmoji.initExpression = function (expressCount, callback) {
            var me = this;
        ...
        RongIMEmoji.retrievalName = function (str) {
            var me = this;
         ...
         */
        RongIMEmoji.getExpressions = function (str) {
            var me = this;
         ...
         */
        RongIMEmoji.retrievalEmoji = function (str) {
            var me = this;
            str = str.replace(/[\uf000-\uf700]/g, function (em) {
                return me.calcUTF(em) || em;
            });
